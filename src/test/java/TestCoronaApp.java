...
public class TestCoronaApp {
    ...
    @Test
     void experimentMet4PersonenInEenHuis() {
        ...
        if (Persoon.AantalPersonen >= 6 && Persoon.AantalPersonen <= 100) {
            System.out.println("Hierbij schrijven wij een boete uit van 95 euro aan huiseigenaar " + huis1.getPersoon().getNaam());
        }
        else if (Persoon.AantalPersonen > 100 && Persoon.AantalPersonen <= 1000) {
            System.out.println("Hierbij schrijven wij een boete uit van 395 euro aan huiseigenaar " + huis1.getPersoon());
        }
        else if (Persoon.AantalPersonen < 6) {
            System.out.println("Controle uitgevoerd en niets strafbaars ontdekt bij het huis van " + huis1.getPersoon().getNaam());
        }
        else if (Persoon.AantalPersonen <= 0){
